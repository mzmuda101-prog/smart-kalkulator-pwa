    ...
    window.MATM0_COMMAND_DEFINITIONS = {
        ...
        graph: [
            ...
            },
            {
                ...
                items: [
                    { syntax: 'punkt=x;y', command: 'punkt=150;200 {PIPE} label=A {PIPE} r=8', description: 'x = współrzędna pozioma, y = pionowa (rozdziel ;). r = promień kółka, label = podpis.' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { syntax: 'kąt=H  (lub kąt=H;V)', command: 'kamera=0;0;4 {PIPE} kąt=105;55 {PIPE} zasięg=30 {PIPE} cel=-1,5;10', description: 'H = kąt poziomy (°). Druga liczba V (po ;) = kąt PIONOWY — skrót zamiast osobnego kątZ=. Czyli kąt=105;55 ≡ kątXY=105 ,, kątZ=55.' },
                    ...
                    { syntax: 'azymut=A  (lub azymut=A,V)', command: 'kamera=0,0,4 {PIPE} kątXY=90 {PIPE} kątZ=55 {PIPE} azymut=135,-30 {PIPE} zasięg=30', description: 'kierunek jak na kompasie: 0°=góra (płn.), 90°=prawo, zgodnie z zegarem. Druga liczba V = pion: dodatnia patrzy w górę, ujemna w dół (np. azymut=135,-20 = 20° w dół). Realnie: gdy oś idzie w górę, pokrycie ziemi maleje, a powyżej horyzontu znika. Pełny rzut na ziemię licz z wysokością z= i pionowym FOV kątZ=.' },
                    { syntax: 'kierunek=A  (lub kierunek=A,V)', command: 'kamera=0,0,4 {PIPE} kątXY=90 {PIPE} kątZ=55 {PIPE} kierunek=90,-30 {PIPE} zasięg=30', description: 'kierunek matematyczny: 0°=w prawo (+X), rośnie przeciwnie do zegara. Druga liczba V = pion: dodatnia w górę, ujemna w dół (np. kierunek=45,15 = 15° w górę). Realnie: oś w górę = mniejsze/znikające pokrycie ziemi; pełny rzut na ziemię przy z= + kątZ=.' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { syntax: 'kątXY=K  (kąt poziomy)', command: 'kamera=0;0;4 {PIPE} kątXY=105 {PIPE} kątZ=55 {PIPE} cel=-1,5;10 {PIPE} zasięg=30', description: 'kąt widzenia w poziomie (płaszczyzna XY). Aliasy: kąt=, kąt_poziomy=, hfov=. Skrót obu naraz: kąt=105;55.' },
                    { syntax: 'kątZ=V  (kąt pionowy)', command: 'kamera=0;0;4 {PIPE} kątXY=105 {PIPE} kątZ=55 {PIPE} cel=-1,5;10 {PIPE} zasięg=30', description: 'kąt widzenia w pionie (oś Z). Bez niego nie policzymy martwej strefy ani pokrycia na ziemi. Aliasy: kąt_pionowy=, vfov=, albo 2. liczba w kąt=H;V.' },
                    { syntax: 'pochył=P  (tilt)', command: 'kamera=0;0;4 {PIPE} kąt=90;40 {PIPE} pochył=30 {PIPE} zasięg=25', description: 'pochylenie osi w dół (0=poziomo, 90=prosto w dół) — tu liczba dodatnia patrzy W DÓŁ (przeciwnie niż V w azymut/kierunek, gdzie dodatnia = w górę). Jeśli pominiesz, a podasz z= i cel= — policzę je sam z geometrii. Aliasy: pochył=, tilt=.' },
                ],
            },
            {
                title: 'Przykłady',
